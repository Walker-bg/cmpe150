...
##### Use This: $ python3 Homework4 - FilePrinter.py
#or $ python3 Homework4 - FilePrinter.py > testoutput.txt
# $ python .\Homework4 - FilePrinter.py > testoutput.txt
